...
| Package | URL | Version |
|---|---|---|
| `prestoplay-apple-core-spm` | `https://github.com/castlabs/prestoplay-apple-core-spm.git` | `from: 4.1.2` |
...
| `smartlib-package` | `https://delivery-platform.broadpeak.tv/ios/broadpeak/smartlib-package.git` | `from: 6.0.2` |
| `plugin-ios` | `https://bitbucket.org/npaw/plugin-ios.git` | `from: 7.3.31` |
| `conviva-ios-sdk-spm` | `https://github.com/Conviva/conviva-ios-sdk-spm.git` | `from: 4.0.47` |
| `stats-sdk-objc` | `https://github.com/muxinc/stats-sdk-objc.git` | `from: 5.13.0` |
